...
New migration files should always be committed and pushed to github. Remember to always run `migrate:latest` to get the latest version of the db, in case someone changes something. Also if you make changes to the schema please tell other people.